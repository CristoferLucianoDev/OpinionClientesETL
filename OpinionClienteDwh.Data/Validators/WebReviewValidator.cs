...
public sealed class WebReviewValidator : IValidator<WebReviewDto>
{
    public bool EsValido(WebReviewDto dto, out string? motivoRechazo)
    {
        ...
        {
            motivoRechazo = $"Rating fuera de rango: {dto.Rating}.";
            return false;
        }
